    ...
    def rgb_callback(self, msg):
        ...
        if len(contours) != 0:
            ...
            ####### # count = 0
                    ...
                    #     if count <= 4 and xk <= largest_mask.shape[1]: # Should check if this should be 4 or 3 or whatever
            ...
            ####### #     count = 0
                   ...
                   # Put circles for debugging
                    for corner in corner_list:
                        cv2.circle(frame, tuple(corner), 15, (255, 0, 0), 5)
                        # Just bear with me
                        # It used to be
                    ...
                    if corner_list.size:
                        ...
                        # Again bear with me
                        # It used to be 
                        # best_corner=(int(corner_list[0].pt[0]), int(corner_list[0].pt[1]))
